            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="#"><i class="fa fa-trash"></i> Tempat Sampah <span class="fa fa-chevron-down"></span></a></li>
          ...
          <div class="">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                      <img src="images/sampah.png" style="text-align: center; width: 200px; height: 276px; margin-bottom:-170px;" >
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Lantai
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
